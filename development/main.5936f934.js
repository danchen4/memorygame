...
},{"core-js/library/fn/promise":"../node_modules/core-js/library/fn/promise.js"}],"../src/js/utility.js":[function(require,module,exports) {
"use strict";
...
},{"@babel/runtime-corejs2/core-js/promise":"../node_modules/@babel/runtime-corejs2/core-js/promise.js"}],"../src/js/messages.js":[function(require,module,exports) {
"use strict";
...
var messages = function () {
  ...
  return {
    selectDifficultyMessage: function selectDifficultyMessage() {
      message.innerHTML = difficultyMessage;
      var difficultyLevel = message.querySelector('.difficulty');
      return {
        message: message,
    ...
    winMessage: function winMessage() {
      message.innerHTML = _winMessage;
      var again = message.querySelector('.play-again');
      return {
        message: message,
        again: again
      };
    ...
    loseMessage: function loseMessage() {
      message.innerHTML = _loseMessage;
      var again = message.querySelector('.play-again');
      return {
        message: message,
        again: again
...
},{"../core-js/object/define-property":"../node_modules/@babel/runtime-corejs2/core-js/object/define-property.js"}],"../src/js/settings.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.BOARDEMOJIS = exports.DIFFICULTY = exports.TIME_BETWEEN_ROUNDS = exports.MAX_FLIPS_PER_ROUND = void 0;
...
// Variables
var MAX_FLIPS_PER_ROUND = 2; //total number of panel flips allowed

exports.MAX_FLIPS_PER_ROUND = MAX_FLIPS_PER_ROUND;
var TIME_BETWEEN_ROUNDS = 1000;
exports.TIME_BETWEEN_ROUNDS = TIME_BETWEEN_ROUNDS;
var DIFFICULTY = {
  EASY_MODE: {
    label: 'easy',
    panels: 8,
...
var BOARDEMOJIS = (_BOARDEMOJIS = {}, (0, _defineProperty2.default)(_BOARDEMOJIS, DIFFICULTY.EASY_MODE.label, [].concat((0, _toConsumableArray2.default)(Array(2).fill(EMOJI.DONUT_EMOJI)), (0, _toConsumableArray2.default)(Array(2).fill(EMOJI.BEER_EMOJI)), (0, _toConsumableArray2.default)(Array(2).fill(EMOJI.MONKEY_EMOJI)), (0, _toConsumableArray2.default)(Array(2).fill(EMOJI.VIOLIN_EMOJI)))), (0, _defineProperty2.default)(_BOARDEMOJIS, DIFFICULTY.MEDIUM_MODE.label, [].concat((0, _toConsumableArray2.default)(Array(2).fill(EMOJI.FOX_EMOJI)), (0, _toConsumableArray2.default)(Array(2).fill(EMOJI.DICE_EMOJI)), (0, _toConsumableArray2.default)(Array(2).fill(EMOJI.POOP_EMOJI)), (0, _toConsumableArray2.default)(Array(2).fill(EMOJI.FIRE_EMOJI)), (0, _toConsumableArray2.default)(Array(2).fill(EMOJI.GHOST_EMOJI)), (0, _toConsumableArray2.default)(Array(2).fill(EMOJI.FOOTBALL_EMOJI)))), (0, _defineProperty2.default)(_BOARDEMOJIS, DIFFICULTY.HARD_MODE.label, [].concat((0, _toConsumableArray2.default)(Array(2).fill(EMOJI.CHEESE_EMOJI)), (0, _toConsumableArray2.default)(Array(2).fill(EMOJI.BOMB_EMOJI)), (0, _toConsumableArray2.default)(Array(2).fill(EMOJI.CRY_EMOJI)), (0, _toConsumableArray2.default)(Array(2).fill(EMOJI.CACTUS_EMOJI)), (0, _toConsumableArray2.default)(Array(2).fill(EMOJI.LOVE_EMOJI)), (0, _toConsumableArray2.default)(Array(2).fill(EMOJI.CROWN_EMOJI)), (0, _toConsumableArray2.default)(Array(2).fill(EMOJI.ALIEN_EMOJI)), (0, _toConsumableArray2.default)(Array(2).fill(EMOJI.BOLT_EMOJI)))), _BOARDEMOJIS);
exports.BOARDEMOJIS = BOARDEMOJIS;
},{"@babel/runtime-corejs2/helpers/defineProperty":"../node_modules/@babel/runtime-corejs2/helpers/defineProperty.js","@babel/runtime-corejs2/helpers/toConsumableArray":"../node_modules/@babel/runtime-corejs2/helpers/toConsumableArray.js"}],"../src/js/gameBoard.js":[function(require,module,exports) {
"use strict";
...
var gameBoard = function () {
  ...
  var round = document.querySelector('.scoreboard__rounds');
  var boardArray = (0, _toConsumableArray2.default)(board.children);
  var difficulty = _settings.DIFFICULTY.MEDIUM_MODE;
  var boardData = null;

  function createBoard() {
    board.innerHTML = (0, _toConsumableArray2.default)(Array(difficulty.panels)).map(function (panel, index) {
      return "\n        <div class=\"panel\" data-index=".concat(index, ">\n            <div class=\"panel__side panel__side--front front\"></div>\n            <div class=\"panel__side panel__side--back back\">\n              <div class=\"panel__emoji\"></div>\n            </div>\n        </div>\n      ");
    }).join('');
    boardArray = (0, _toConsumableArray2.default)(board.children);
  }

  function initializeBoardData() {
    var boardEmojiCopy = (0, _toConsumableArray2.default)(_settings.BOARDEMOJIS[difficulty.label]);
    return (0, _toConsumableArray2.default)(Array(difficulty.panels)).map(function (panel, index) {
      return {
        id: {
          index: index
        },
        emoji: boardEmojiCopy.splice((0, _utility.getRandomInt)(boardEmojiCopy.length), 1).join(''),
        flipped: false,
        matched: false
      };
    });
  ...
  function selectMode(e, message) {
    ...
    switch (mode) {
      case _settings.DIFFICULTY.EASY_MODE.label:
        difficulty = _settings.DIFFICULTY.EASY_MODE;
        initializeBoard();
        return;

      case _settings.DIFFICULTY.MEDIUM_MODE.label:
        difficulty = _settings.DIFFICULTY.MEDIUM_MODE;
        initializeBoard();
        return;

      case _settings.DIFFICULTY.HARD_MODE.label:
        difficulty = _settings.DIFFICULTY.HARD_MODE;
        initializeBoard();
        return;
  ...
  return {
    ...
    promptDifficulty: function promptDifficulty() {
      var _messages$selectDiffi = _messages.messages.selectDifficultyMessage(),
          message = _messages$selectDiffi.message,
          difficultyLevel = _messages$selectDiffi.difficultyLevel;
    ...
    getBoardArray: function getBoardArray() {
      return boardArray;
    }
  };
}();
...
},{"@babel/runtime-corejs2/helpers/toConsumableArray":"../node_modules/@babel/runtime-corejs2/helpers/toConsumableArray.js","./utility.js":"../src/js/utility.js","./messages.js":"../src/js/messages.js","./settings.js":"../src/js/settings.js"}],"../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
},{"regenerator-runtime":"../node_modules/regenerator-runtime/runtime.js"}],"../node_modules/@babel/runtime-corejs2/helpers/asyncToGenerator.js":[function(require,module,exports) {
...
},{"../core-js/promise":"../node_modules/@babel/runtime-corejs2/core-js/promise.js"}],"../src/js/game.js":[function(require,module,exports) {
"use strict";
...
var game = function () {
  ...
  var flipHistory = [];
  var round = document.querySelector('.scoreboard__rounds');
  var board = document.querySelector('.board'); // Methods

  function boardAction(_x) {
    return _boardAction.apply(this, arguments);
  }

  function _boardAction() {
    _boardAction = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(e) {
      var boardData, boardArray, difficulty, panelElement, panelIndex;
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              boardData = _gameBoard.gameBoard.getBoardData();
              boardArray = _gameBoard.gameBoard.getBoardArray();
              difficulty = _gameBoard.gameBoard.getDifficulty(); // Event delegation

              if (e.target.classList.contains('panel__side')) {
                _context.next = 6;
                break;
              }
            ...
            case 6:
              panelElement = e.target.parentElement;
              panelIndex = panelElement.dataset.index; // 1. Flip panels

              flipPanel(panelElement, panelIndex, boardData); // 2. On second flip, check:

              if (!(flipCounter >= _settings.MAX_FLIPS_PER_ROUND)) {
                _context.next = 17;
                break;
              }

              // 3. If there is a match, then update boardData
              checkMatch(boardData); // 4. Remove event listeners so player can't flip panels

              board.removeEventListener('click', boardAction);
              board.removeEventListener('touchstart', boardAction); // 5. Pause

              _context.next = 15;
              return (0, _utility.sleep)(_settings.TIME_BETWEEN_ROUNDS);

            case 15:
              // 6. End the round
              endRound(boardData, boardArray); // 7. Check if player won or loss after the end of the round
  ...
  function flipPanel(panelElement, panelIndex, boardData) {
    ...
    flipHistory.push(panelIndex); // rotate the front side by -180deg

    panelElement.firstElementChild.style.transform = 'rotateY(-180deg)'; // and rotate the back side by to 0
  ...
  function promptNewGame(e, message) {
    ...
    var again = e.target.dataset.again;
    message.classList.remove('message--active');
  ...
  function checkWinLoss(boardData, difficulty) {
    var remainingUnmatched = boardData.filter(function (panel) {
      return !panel.matched;
    }).length;
    var remainingRounds = difficulty.rounds - gameRound; // If all panels have been matched then player wins

    if (!remainingUnmatched) {
      var _messages$winMessage = _messages.messages.winMessage(),
          message = _messages$winMessage.message,
          again = _messages$winMessage.again;
    ...
    if (!remainingRounds) {
      var _messages$loseMessage = _messages.messages.loseMessage(),
          _message = _messages$loseMessage.message,
          _again = _messages$loseMessage.again;

      _message.classList.add('message--active');

      _again.addEventListener('click', function (e) {
        promptNewGame(e, _message);
      });
  ...
  function resetGame() {
    ...
    _gameBoard.gameBoard.promptDifficulty();
  ...
  function updateGameRound() {
    return _updateGameRound.apply(this, arguments);
  }

  function _updateGameRound() {
    _updateGameRound = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
      var difficulty;
      return _regenerator.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              difficulty = _gameBoard.gameBoard.getDifficulty();
...
exports.game = game;
},{"@babel/runtime-corejs2/regenerator":"../node_modules/@babel/runtime-corejs2/regenerator/index.js","@babel/runtime-corejs2/helpers/asyncToGenerator":"../node_modules/@babel/runtime-corejs2/helpers/asyncToGenerator.js","./gameBoard.js":"../src/js/gameBoard.js","./messages.js":"../src/js/messages.js","./utility.js":"../src/js/utility.js","./settings.js":"../src/js/settings.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
(function () {
  _gameBoard.gameBoard.initializeBoard();

  _gameBoard.gameBoard.promptDifficulty();

  _game.game.startRound();
})();
},{"./gameBoard.js":"../src/js/gameBoard.js","./game.js":"../src/js/game.js","../sass/main.scss":"../src/sass/main.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
